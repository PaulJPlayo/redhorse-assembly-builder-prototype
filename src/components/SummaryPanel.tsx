  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed right-3 top-1/2 z-[70] flex h-14 w-14 -translate-y-1/2 items-center justify-center rounded-full bg-[#e82133] text-[11px] font-bold uppercase tracking-[0.14em] text-white shadow-[0_10px_24px_rgba(0,0,0,0.25)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#e82133] sm:hidden"
      >
